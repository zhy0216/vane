...
function generateGuide(): string {
  const components: ComponentInfo[] = [
    // Basic Structure Components - NOTE: html, body, and head are excluded from LLM usage
...
**DO NOT use the following components:**
- \`html\` - This is automatically generated by the system
- \`head\` - This is automatically generated by the system
- \`body\` - This is automatically generated by the system

These structural tags are handled automatically by the email rendering system. Start your component tree with layout components like \`container\` or \`section\`.
